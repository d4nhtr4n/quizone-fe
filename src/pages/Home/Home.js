...
const articles = [
    ...
    {
        image: "https://matsaigonnhatrang.com/Uploads/images/Blogs/web1-p2qtnhp5.jpg",
        ...
        <div className={cx("wrapper")}>
            <div className={cx("introduction")}>
                <div className={cx("text-container")}>
                    <h1>Play Online Quiz & Win Cash Daily!</h1>
                    <h5>Win up to 1.000.000 VND monthly from Quizzer.</h5>
                    <h4>Number of active users right now</h4>
                    <h3>20,000+</h3>
                </div>
                <Image
                    src={images.computer}
            ...
            <div className={cx("challenges")}>
                    ...
                    <div>
                        <div className={cx("model")}>
                            ...
                            <p>
                                ...
                                placerat tortor commodo lectus laoreet
                                venenatis.
                            </p>
                        </div>
                        <Image src={images.learningBoy} alt="Learning Boy" />
                    </div>
                    <div>
                        <Image src={images.primaryExam} alt="Primary Exam" />
                        <h3>Primary Exam</h3>
                    </div>
                </div>
                <div className={cx("exams")}>
                    ...
                    <div>
                        <Image src={images.railwayExam} alt="Railway Exam" />
                        <h3>Railway Exam</h3>
                    </div>
                </div>
            </div>
            ...
            <div className={cx("rewards")}>
                ...
                <div>
                    <div className={cx("winners")}>
                        <div className={cx("left-column")}>
                            <div className={cx("week")}>
                                <h2>Weekly</h2>
                                <h3>Winner</h3>
                            </div>
                            <Image src={images.monthly} />
                        </div>
            ...
            <div className={cx("articles")}>
                ...
                >
                    {articles?.map((item, index) => (
                        <div key={index} className={cx("article-container")}>
                            <Image
                                src={item.image}
